<template>
  <div>
    <Card dis-hover>
      <Row class="RowOne">
        <ul class="ulList">
          <li><DatePicker class="dataPicker" type="daterange" placement="bottom-end"  :value="dateRangePick"
    ...
    <Row :gutter="20" class="RowTwo">
      <i-col class="con" span="8" v-for="(infor, i) in inforCardData" :key="`infor-${i}`" >
